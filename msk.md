...
{% include image-grid.html cols=1 img1="msk4.png" %}
{% include image-grid.html cols=1 img1="msk5.png" %}
{% include image-grid.html cols=1 img1="msk6.png" %}
...
{% include image-grid.html cols=1 img1="msk7.png" %}
{% include image-grid.html cols=1 img1="msk8.png" %}
{% include image-grid.html cols=1 img1="msk9.png" %}

In order to present my work at lab meeting, I had to benchmark and compare my tool with the other two existing solutions.

{% include image-grid.html cols=1 img1="msk10.png" %}
{% include image-grid.html cols=1 img1="msk11.png" %}
{% include image-grid.html cols=1 img1="msk12.png" %}
{% include image-grid.html cols=1 img1="msk13.png" %}
{% include image-grid.html cols=1 img1="msk14.png" %}
{% include image-grid.html cols=1 img1="msk15.png" %}
{% include image-grid.html cols=1 img1="msk16.png" %}
