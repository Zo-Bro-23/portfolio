---
layout: post
title: Cross-Disciplinary Schoolwork
description: Engineering projects I did for schoolwork in other subjects
---
<style>
...
- A large centerpiece map showing landmasses and water
- My old school – aerial view
- My old house – model
- My housing colony – model/map
- The Kochi airport
- The Kochi Metro public transit map
- My cousin’s house
...
{% include image-grid.html cols=1 img1="english7.png" %}
{% include image-grid.html cols=1 img1="english8.png" %}
{% include image-grid.html cols=2
  img1="english9.png"
  img2="english10.png"
%}

{% include image-grid.html cols=1 img1="english11.png" %}
{% include image-grid.html cols=2
  img1="english12.png"
  img2="english13.png"
%}
